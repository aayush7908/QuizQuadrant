...
const getMySavedQuestionsAction = async (pageNumber: number) => {
    try {
        ...
        // API call
        const res = await fetch(`${serverEnv.BACKEND_BASE_URL}/question/get/my/saved?pageNumber=${pageNumber}&pageSize=${pageSize}`, {
            method: "GET",
            cache: "no-cache",
            headers: {
