...
const getAllUsersAction = async (pageNumber: number) => {
    try {
        ...
        // API call
        const res = await fetch(`${serverEnv.BACKEND_BASE_URL}/admin/user/get/all?pageNumber=${pageNumber}&pageSize=${pageSize}`, {
            method: "GET",
            cache: "no-cache",
            headers: {
